...
void _subdivideQuadSpline(undefined8 param_1,double param_2,double param_3,double param_4,undefined8 *param_5,undefined8 *param_6);
void _subdivideQuadCurve(undefined8 param_1,undefined8 *param_2,long param_3,long param_4);
bool _rectsOverlap(double param_1,double param_2,double param_3,double param_4,double param_5,double param_6,double param_7,double param_8);
...
void _testIntersect(double param_1,undefined8 *param_2,undefined8 *param_3,undefined *param_4,undefined *param_5,undefined8 *param_6);
bool _seemsToBeDuplicate(double param_1,double param_2,double param_3,long param_4,int param_5);
void _findIntersects(undefined param_1 [16],undefined8 param_2,undefined8 param_3,undefined8 param_4,long param_5);
undefined8 entry(void);
void ___assert_rtn(char *param_1,char *param_2,int param_3,char *param_4);
void ___stack_chk_fail(void);
void * _memcpy(void *param_1,void *param_2,size_t param_3);
int _printf(char *param_1,...);
undefined ___chkstk_darwin();
