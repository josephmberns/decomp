...
undefined  [16]_perpendicular_distance(undefined8 param_1,double param_2,double param_3,double param_4,double param_5,double param_6);
long _douglas_peucker(double param_1,undefined8 *param_2,ulong param_3,undefined8 *param_4,ulong param_5);
