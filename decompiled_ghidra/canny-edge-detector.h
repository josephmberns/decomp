...
void _convolution(long param_1,long param_2,long param_3,int param_4,int param_5,int param_6,byte param_7);
void _gaussian_filter(float param_1,undefined8 param_2,undefined8 param_3,undefined4 param_4,undefined4 param_5);
void * _canny_edge_detection(undefined4 param_1,undefined8 param_2,long param_3,int param_4,int param_5);
