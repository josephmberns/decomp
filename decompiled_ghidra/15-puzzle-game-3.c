...
void _View_setup_base(void)

{
  undefined4 local_4;
  
  __fieldWidth = 0;
  for (local_4 = 0xf; 0 < local_4; local_4 = local_4 / 10) {
    __fieldWidth = __fieldWidth + 1;
  }
  return;
}
