#include "abbreviations-simple.h"
...

{
  ...
  local_28 = 0;
  local_18 = param_1;
  local_30 = (void *)_split_into_words(param_1,&local_28);
  for (local_38 = 0; local_38 < local_28; local_38 = local_38 + 1) {
    local_40 = *(char **)((long)local_30 + local_38 * 8);
    local_48 = (undefined8 *)_xmalloc(0x20);
    local_50 = _strlen(local_40);
    local_48[1] = local_50;
    local_48[2] = local_50;
    uVar1 = _uppercase(local_40,local_50);
    *local_48 = uVar1;
    if (local_38 + 1 < local_28) {
      local_58 = (char *)0x0;
      uVar2 = _strtoul(*(char **)((long)local_30 + (local_38 + 1) * 8),&local_58,10);
      if ((uVar2 != 0) && (*local_58 == '\0')) {
        _free(*(void **)((long)local_30 + (local_38 + 1) * 8));
        local_48[2] = uVar2;
        local_38 = local_38 + 1;
      }
    }
...

{
  int iVar1;
                    ...
                    // WARNING: Treating indirect jump as call
  iVar1 = (*(code *)PTR__strncmp_100004050)((int)param_1);
  return iVar1;
}
...

{
  ulong uVar1;
                    ...
                    // WARNING: Treating indirect jump as call
  uVar1 = (*(code *)PTR__strtoul_100004058)(param_1,param_2,param_3);
  return uVar1;
}
