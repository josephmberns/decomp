#include "15-puzzle-game-1.h"



// WARNING: Globals starting with '_' overlap smaller symbols at the same address

undefined4 _update(uint param_1)

{
  ...
  local_40[0] = -1;
  local_40[1] = 1;
  iVar1 = __hR + local_40[param_1];
  iVar2 = __hC + local_40[(ulong)param_1 + 4];
  if ((((iVar1 < 0) || (3 < iVar1)) || (iVar2 < 0)) || (3 < iVar2)) {
    local_44 = 0;
  }
  else {
    *(undefined4 *)(&_cc + (long)__hC * 4 + (long)__hR * 0x10) =
         *(undefined4 *)(&_cc + (long)iVar2 * 4 + (long)iVar1 * 0x10);
    *(undefined4 *)(&_cc + (long)iVar2 * 4 + (long)iVar1 * 0x10) = 0;
    local_44 = 1;
    __hC = iVar2;
    __hR = iVar1;
  }
...

{
  ...
  for (local_14 = 0; local_14 < 4; local_14 = local_14 + 1) {
    for (local_18 = 0; local_18 < 4; local_18 = local_18 + 1) {
      *(int *)(&_cc + (long)local_18 * 4 + (long)local_14 * 0x10) = local_18 + local_14 * 4 + 1;
    }
  }
  _DAT_10000803c = 0;
  __hR = 3;
...

{
  ...
  do {
    ...
    for (local_c = 0; local_c < 4; local_c = local_c + 1) {
      if ((local_10 < 0x10) &&
         (bVar1 = *(int *)(&_cc + (long)local_c * 4 + (long)local_8 * 0x10) != local_10,
...

{
  ...
  for (local_14 = 0; local_14 < 4; local_14 = local_14 + 1) {
    for (local_18 = 0; local_18 < 4; local_18 = local_18 + 1) {
      if (*(int *)(&_cc + (long)local_18 * 4 + (long)local_14 * 0x10) == 0) {
        pcVar1 = " %2s ";
        if (local_18 == 3) {
          pcVar1 = " %2s \n";
        }
